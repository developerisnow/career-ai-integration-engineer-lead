---
version: "1.0.0"
last_edited: "2025-07-13 21:00"
created: "2025-07-13 21:00"
status: "draft"
type: "prd"
category: "product"
tags: [product, social, ai, relationships, toxicity, crm]
prompt: "create PRD for toxic people cleaner product based on existing Assistant Telegram work"
---
...
## 📋 Request Checklist
What you asked for:
- [x] Сформулировать PRD для продукта очистки от токсичных людей
- [x] Использовать существующие наработки Assistant Telegram
- [x] Добавить примеры и зацепки для quantum brain
- [x] ADHD-friendly формат
...
```mermaid
graph TD
    A[Your Communications] --> B[AI Analysis Engine]
    B --> C[Toxicity Detection]
    B --> D[Support Detection]
    B --> E[Pattern Recognition]
    
    C --> F[Red Flags Dashboard]
    D --> G[Hidden Gems List]
    E --> H[Relationship Insights]
    
    F --> I[Action: Limit/Exit]
    G --> J[Action: Reconnect]
    H --> K[Action: Calibrate]
```
...
graph TB
    subgraph "Data Collection"
        A[Telegram Export] --> E[Processing Queue]
        B[Voice Transcripts] --> E
        C[Email/Calendar] --> E
        D[Biometrics] --> E
    end
    ...
    subgraph "User Interface"
        J --> K[Dashboard]
        K --> L[Red Flags View]
        K --> M[Hidden Gems View]
        K --> N[Action Recommendations]
    end
```
